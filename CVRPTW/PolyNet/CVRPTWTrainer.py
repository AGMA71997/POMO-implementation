...
from CVRPTWModel import CVRPTWModel as Model
...
class CVRPTWTrainer:
    ...
    def _train_one_batch(self, batch_size):
        ...
        ###############################################
        self.model.train()
        self.env.load_problems(batch_size, rollout_size, self.device)
    ...
    def _validate(self, greedy_construction=False, use_augmentation=False):
        ...
        while episode < val_num_episode:
            ...
            with torch.no_grad():
                ...
                prob_list = torch.zeros(size=(batch_size * aug_factor, val_env.rollout_size, 0))
                while not done:
